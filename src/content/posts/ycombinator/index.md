...
#code ./resources/fib2-expanded.scm
...
#code ./resources/self-application.scm
...
#code ./resources/recursive-fib.scm
...
#code ./resources/abstract-self-application.scm
...
#code ./resources/y-with-fibonacci.scm

Bam. If you try this out in your IDE right now([repl.it](https://repl.it/) has a scheme interpreter), you'll see that it works! The final step is just cleaning up the variable names. Here is the long awaited YCombinator!

#code ./resources/y-combinator.scm
